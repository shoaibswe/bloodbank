    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        ...
        <form action="need_blood.php" method="post" enctype="multipart/form-data">
          ...
          <div class="form-group">
            <input type="date" class="form-control" name="datepicker" id="datepicker" placeholder="Enter date"></input>
          </div>
          ...
          <div class="form-group">
           ...
           <div class="form-group">
            <input type="number" class="form-control" name="contact" id="contact" placeholder="Enter contact"></input>
          </div>
             <div class="form-group">

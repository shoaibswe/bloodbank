			...
			<div class="sidebar-scroll">
				<nav>
					<ul class="nav">
						...
						<li><a href="request.php" class=""><i class="lnr lnr-code"></i> <span>My Requests</span></a></li>
						<li><a href="request_others.php" class=""><i class="lnr lnr-code"></i> <span>Other Requests</span></a></li>
